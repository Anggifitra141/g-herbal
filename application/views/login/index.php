...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>G herbal | Aftersale | User Login </title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="#">
              ...
              <h1 style="color:#35af31; font-weight:bold;">G <span style="color:#35af31;">Herbal </span></h1>
            </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" role="login" action="<?= site_url() ?>login/check/" onsubmit="return post(this);" method="post">
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright">
          <h4 style="color:#fff;"> 2018 &copy; G herbal. </h4>
          <h5 style="color:#fff;"> All right Reserved </h5>
        </div>
        <!-- END COPYRIGHT -->
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
